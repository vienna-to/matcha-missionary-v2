...
const orderSpecs: OrderSpec[] = [
  ...
  { num: 6, name: "Devon", time: "11:42", paymentStatus: "paid", paymentMethod: "zelle", items: [{ menuItemId: "mi_dubai", quantity: 1, milkChoiceId: "ing_milk_oat" }] },
  ...
  { num: 15, name: "Skyler", time: "12:46", paymentStatus: "paid", paymentMethod: "venmo", items: [{ menuItemId: "mi_ube", quantity: 1, milkChoiceId: "ing_milk_almond" }] },
  ...
  { num: 21, name: "Andy", time: "13:42", paymentStatus: "paid", paymentMethod: "zelle", items: [{ menuItemId: "mi_classic", quantity: 1 }, { menuItemId: "mi_cheesecake", quantity: 1 }] },
  ...
  { num: 26, name: "Park", time: "14:42", paymentStatus: "paid", paymentMethod: "cash", items: [{ menuItemId: "mi_earlgrey", quantity: 1 }] },
